...
public class MainActivity extends AppCompatActivity {
    ...
    private static final String TAG = "ContentProviderTAG";
    ...
    private String mSelectionCluse = ContactsContract.Contacts.DISPLAY_NAME_PRIMARY + " = 'Ajay'";
    ...
    private void getContacts()
    {
      /*  Log.d(TAG,"called");
        ...
        if (cursor.getCount() > 0) {
            ...
            textViewQueryResult.setText(output.toString());
        }
    }
}